// Add dependency on path to locate files in filesystem.
...
function createContractInstance(alicePk, bobPk, carolPk, dataHash, timeout, network)
{
	...
	return Contract.fromCashFile(path.join(__dirname, 'contract.cash'), network).new(alicePk, bobPk, carolPk, dataHash, timeout);
}
